    ...
    <form class="w-full" @submit.prevent="handleSearchParams">
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
          ...
          <input type="text" class="block border border-grey-light w-full py-3 px-4 mb-3 rounded" name="memberName"
            placeholder="Search Name" v-model="searchParams.memberName" />
        </div>
        <!-- Search Phone -->
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
          <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
            for="grid-first-name">Phone</label>
          <input type="text" class="block border border-grey-light w-full py-3 px-4 mb-3 rounded" name="memberPhone"
            placeholder="Search Phone" v-model="searchParams.memberPhone" />
        </div>
        <!-- Search Date -->
        ...
        <tbody>
          <tr v-for="(member, index) in paginatedMembers" :key="index"
            ...
            <td class="px-6 py-4">
              ...
              <!-- UPDATE BUTTON -->
              <button type="button" class="focus:outline-none px-5" @click="showUpdateButton(member.memberNo)">
                <svg class="w-6 h-6 text-teal-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
              ...
              <!-- DELETE BUTTON -->
              <button type="button" class="focus:outline-none px-5" @click="showDeleteButton">
              ...
              <div v-if="confirmDeleteForm" :class="{ 'blur-background': confirmDeleteForm }"
                class="fixed inset-0 flex items-center justify-center bg-opacity-75 backdrop-blur-md">
                <div class="bg-white dark:bg-gray-800 p-6 border rounded-lg shadow-lg">
                  <div class="flex justify-end">
                    <button @click="closeDeleteConfirmForm" type="button"
                  ...
                  <div class="p-6 pt-0 text-center">
                    ...
                    <button type="button" @click="confirmDelete(member)"
